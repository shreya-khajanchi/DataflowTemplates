...
public interface DataWriter extends AutoCloseable {
   ...
   * @param operation one of {@link com.google.cloud.teleport.v2.templates.utils.Constants#MUTATION_INSERT},
   *     {@code MUTATION_UPDATE}, or {@code MUTATION_DELETE}.
   */
  void write(List<Row> rows, DataGeneratorTable table, String shardId, String operation);
