...
public final class Type implements Serializable {
  ...
  private static final Type TYPE_ARRAY_JSON = new Type(Type.Code.ARRAY, TYPE_JSON, null);
  private static final Type TYPE_ARRAY_BYTES = new Type(Type.Code.ARRAY, TYPE_BYTES, null);
  private static final Type TYPE_ARRAY_TIMESTAMP = new Type(Type.Code.ARRAY, TYPE_TIMESTAMP, null);
  private static final Type TYPE_ARRAY_DATE = new Type(Type.Code.ARRAY, TYPE_DATE, null);
  private static final Type TYPE_ARRAY_UUID = new Type(Type.Code.ARRAY, TYPE_UUID, null);
  ...
  private static final Type TYPE_PG_NUMERIC = new Type(Type.Code.PG_NUMERIC, null, null);
  private static final Type TYPE_PG_JSONB = new Type(Type.Code.PG_JSONB, null, null);
  ...
  private static final Type TYPE_PG_ARRAY_VARCHAR =
      new Type(Type.Code.PG_ARRAY, TYPE_PG_VARCHAR, null);
  private static final Type TYPE_PG_ARRAY_TEXT = new Type(Type.Code.PG_ARRAY, TYPE_PG_TEXT, null);
  private static final Type TYPE_PG_ARRAY_NUMERIC =
      new Type(Type.Code.PG_ARRAY, TYPE_PG_NUMERIC, null);
  private static final Type TYPE_PG_ARRAY_JSONB = new Type(Type.Code.PG_ARRAY, TYPE_PG_JSONB, null);
  private static final Type TYPE_PG_ARRAY_BYTEA = new Type(Type.Code.PG_ARRAY, TYPE_PG_BYTEA, null);
  private static final Type TYPE_PG_ARRAY_TIMESTAMPTZ =
      new Type(Type.Code.PG_ARRAY, TYPE_PG_TIMESTAMPTZ, null);
  private static final Type TYPE_PG_ARRAY_DATE = new Type(Type.Code.PG_ARRAY, TYPE_PG_DATE, null);
  private static final Type TYPE_PG_ARRAY_UUID = new Type(Type.Code.PG_ARRAY, TYPE_PG_UUID, null);
  ...
  /**
   * Returns the descriptor for the GoogleSQL {@code UUID} type: a fixed 128-bit unique identifier
   * rendered as the canonical 8-4-4-4-12 lowercase hex form.
   */
  ...
  /** Returns the descriptor for the PG Spanner {@code uuid} type. */
  ...
  public static Type array(Type elementType) {
    ...
    switch (elementType.getCode()) {
      ...
      default:
        return new Type(Type.Code.ARRAY, elementType, null);
    }
  }
  ...
  public static Type struct(Iterable<Type.StructField> fields) {
    return new Type(Type.Code.STRUCT, null, ImmutableList.copyOf(fields));
  }
  ...
  private final Type.Code code;
  private final Type arrayElementType;
  private final ImmutableList<Type.StructField> structFields;
  ...
  private Type(
      ...
      @Nullable ImmutableList<Type.StructField> structFields) {
    this.code = code;
  ...
  public static final class StructField implements Serializable {
    ...
    public static Type.StructField of(String name, Type type) {
      return new Type.StructField(name, type);
    }
    ...
    public boolean equals(Object o) {
      ...
      Type.StructField that = (Type.StructField) o;
  ...
  void toString(StringBuilder b) {
    if (code == Type.Code.ARRAY) {
      ...
      b.append('>');
    } else if (code == Type.Code.PG_ARRAY) {
      arrayElementType.toString(b);
      b.append("[]");
    } else if (code == Type.Code.STRUCT) {
      b.append("STRUCT<");
      for (int i = 0; i < structFields.size(); ++i) {
        if (i > 0) {
          b.append(", ");
        }
        Type.StructField f = structFields.get(i);
